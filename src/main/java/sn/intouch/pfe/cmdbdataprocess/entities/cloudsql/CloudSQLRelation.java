...
public class CloudSQLRelation {
    public static void updateCloudSQLRelation (CloudSQL cloudSQL) throws JSONException, IOException {
        HttpUtil.deleteRelation(RelationshipMapping.CLOUDSQL_VPC_RELATION.split("Map_")[1],"VirtualPrivateCloud","name",cloudSQL.getVpc(),"CloudSQL","name",cloudSQL.getName());
