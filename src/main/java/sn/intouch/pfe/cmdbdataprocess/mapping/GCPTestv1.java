...
public class GCPTestv1 {
    ...
    private static void responseProcessing(AssetServiceClient.ListAssetsPagedResponse response) throws InterruptedException, IOException {
        ...
        for (Asset asset : response.getPage().getValues()) {
            ...
            log.info("type : " + type);
            if (Objects.equals(type, AssetMapping.CLOUD_FUNCTION)){
            ...
            if(Objects.equals(type, AssetMapping.DISK)){
            ...
            if(Objects.equals(type, AssetMapping.SUBNETWORK)){
            ...
            if(Objects.equals(type, AssetMapping.PROJECT)){
            ...
            if(Objects.equals(type, AssetMapping.VPC)){
            ...
            if (Objects.equals(type,AssetMapping.URLMAP)){
            ...
            if (Objects.equals(type, AssetMapping.VM_INSTANCE)) {
            ...
            if(Objects.equals(type,AssetMapping.INSTANCE_GROUP)){
            ...
            if(Objects.equals(type,AssetMapping.CLOUD_SQL)){
            ...
            if(Objects.equals(type,AssetMapping.CLOUD_RUN_EXECUTION)){
